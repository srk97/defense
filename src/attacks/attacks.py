...
class Attack(ABC):
  ...
  def __init__(self, model, device, criterion, hparams, attack_params):
...
class FGSM(Attack):
  ...
  def __init__(self, model, device, criterion, hparams, attack_params):
    ...
    super().__init__(model, device, criterion, hparams, attack_params)
  ...
  def generate(self, data, epsilon, y=None, y_target=None):
    ...
    output = self.model(data, self.hparams)
    ...
    output = self.model(perturbed_data, self.hparams)
...
class PGD(FGSM):
  ...
  def generate(self, X_img, epsilon, y=None, y_target=None):
    ...
    for i in range(self.iters):
      ...
      output = self.model(X_var, self.hparams)
    ...
    output = self.model(perturbed_image, self.hparams)
    final_pred = output.max(1)[1]
